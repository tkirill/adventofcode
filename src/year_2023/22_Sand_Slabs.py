...
class Brick:
    ...
    top: int = dataclasses.field(init=False)
    left: int = dataclasses.field(init=False)
    right: int = dataclasses.field(init=False)
    forward: int = dataclasses.field(init=False)
    backward: int = dataclasses.field(init=False)
